...
const OverallQuality = (props) => {
  ...
  let image = !props.rating && highImage || props.rating > 0.66 && highImage || props.rating > 0.33 && mediumImage || lowImage;
  return (
    <View style={cqStyles.overallRating}>
      <Image source={image} style={cqStyles.ratingImg}/>
      <RMText style={cqStyles.ratingText}>Overall rating: {Math.round(props.rating * 100) || "N/A"} / 100</RMText>
    </View>
  );
};
